...
["Ballot of '#{member_name}' for issue ##{issue_id}"] = "'#{member_name}' 對議案 ##{issue_id} 的表決";
...
["Current votings in areas you are member of and issues you are interested in:"] = "目前在您的主題或您所關心的議案中正進行的表決：";
...
["Issue finished without voting"] = "議案未經表決而結束";
["Issue frozen"] = "議案已底定";
["Issue pad"] = "議案討論版";
["Issue quorum"] = "議案法定門檻";
...
["Member has voting privileges for this unit"] = "該成員對此組織有表決權";
...
["Trustee"] = "受託人";
["Trustee has no voting right in this unit"] = "受託人在此組織中無表決權";
["Tuesday"] = "週二";
...
["Voting for this issue has already begun."] = "對此議案的表決已開始。";
...
["You already voted this issue"] = "您已表決過此議案";
...
["You have not voted #{count} issue(s) you were interested in"] = "您對 #{count} 個您所關心的議案尚未進行表決。";
["You have to mark 'Are you sure' to revoke!"] = "請勾選 '確認' 以撤銷";
["You have voting privileges for this unit"] = "您在此組織有表決權";
