...
["#{count} more areas in this unit"] = "在此單位中另有 #{count} 個領域";
["#{count} new"] = "#{count} 個新的";
["#{count} of them have an area delegation set"] = "其中 #{count} 個已設有領域委任表決";
...
["API keys"] = "API-碼";
["Abandon global delegation for this area"] = "停止此領域中的全面委任表決";
["Abandon unit and area delegations for this issue"] = "停止此議題的單位及領域委任表決";
["Abandon unit delegation for this area"] = "停止此領域的單位委任表決";
["About site"] = "關於本站";
["Abstention"] = "棄權";
...
["Admitted"] = "已遞交";
["All areas"] = "所有的領域";
["All areas in my units"] = "我單位中的所有領域";
["All issues"] = "所有議題";
["All of them"] = "全部";
["All units"] = "所有單位";
["Any"] = "所有";
["Any phase"] = "所有階段";
["Any state"] = "所有狀態";
["Apply global delegation for this area (Currently: #{delegate_name} [#{scope}])"] = "對此領域使用全面委任表決 (目前: #{delegate_name} [#{scope}])";
["Apply global or area delegation for this issue (Currently: #{delegate_name} [#{scope}])"] = "對此議題使用全面或是領域委任表決 (目前: #{delegate_name} [#{scope}])";
["Apply unit delegation for this area (Currently: #{delegate_name} [#{scope}])"] = "對此領域使用單位委任表決 (目前: #{delegate_name} [#{scope}])";
["Apply unit or area delegation for this issue (Currently: #{delegate_name} [#{scope}])"] = "對此議題使用單位或領域委任表決 (目前: #{delegate_name} [#{scope}])";
["Approval (#th preference) [many entries]"] = "批准 (第 # 順位)";
["Approval (#th preference) [single entry]"] = "批准 (第 # 順位)";
["Approval (first preference) [many entries]"] = "批准 (第一順位)";
["Approval (first preference) [single entry]"] = "批准 (第一順位)";
["Approval (second preference) [many entries]"] = "批准 (第二順位)";
["Approval (second preference) [single entry]"] = "批准 (第二順位)";
["Approval (third preference) [many entries]"] = "批准 (第三順位)";
["Approval (third preference) [single entry]"] = "批准 (第三順位)";
["Approval [many entries]"] = "批准";
["Approval [single entry]"] = "批准";
["Approved"] = "通過";
["Are you sure?"] = "您確定嗎?";
["Area"] = "領域";
["Area '#{name}'"] = "領域 '#{name}'";
["Area delegation"] = "領域的委任表決";
...
["Change area delegation"] = "更改領域的委任表決";
["Change email"] = "更改電郵地址";
...
["Default Policy"] = "預設規則";
["Degree"] = "度";
["Delegate area"] = "領域委任表決";
["Delegate issue"] = "議題委任表決";
["Delegate unit"] = "單位委任表決";
...
["No potential supporters (before begin of voting)"] = "無可能支持者 (直到表決開始前)";
["No reverse beat path"] = "無循環性優先順序";
["No suggestions"] = "無建議";
["No suggestions yet"] = "尚無建議";
["No supporters"] = "無支持者";
["No supporters (before begin of voting)"] = "無支持者 (直到表決開始前)";
["Not a member"] = "非成員";
["Not accepted yet"] = "仍未被接受";
["Not approved"] = "不批准";
["Not approved (rank #{rank})"] = "不批准 (順位 #{rank})";
["Not voted"] = "未表決";
...
["One more area in this unit"] = "在這單位多一個領域";
...
["Potential supporters (before begin of voting)"] = "可能支持者 (直到表決開始前)";
...
["Send invite?"] = "送出邀請？";
["Set URL"] = "設定網址";
["Set delegation for Area '#{name}'"] = "為領域 '#{name}' 設定委任表決";
["Set delegation for Issue ##{number} in Area '#{area_name}'"] = "為領域 '#{area_name}'的議題 ##{number} 設定委任表決";
...
["Supported"] = "所支持的";
["Supporters"] = "支持者";
["Supporters (before begin of voting)"] = "支持者 (直到表決開始前)";
...
["This member has rejected to become initiator of this initiative"] = "該成員婉拒成為此提案的發起人。";
["This member is already initiator of this initiative"] = "該成員已是此提案的發起人。";
["This member is already invited to become initiator of this initiative"] = "該成員已被邀請成為此提案的發起人。";
["This member is inactive"] = "該成員怠惰";
["This member is locked"] = "該成員被鎖定";
["This member is participating, the rest of delegation chain is suspended while discussing"] = "該成員參與中，其餘的委任表決鏈在討論期間停用。";
...
["You are potential supporter of this initiative via delegation"] = "經由委任表決，您是此提案的可能支持者。";
...
["Your vote has been discarded. Delegation rules apply if set."] = "您的選票已被放棄。在適用情況下將使用委任表決規則。";
["Z-A"] = "Z-A";
