...
["Abstention [many entries]"] = "Sindeteno";
...
["Any"] = "Kelkaj";
["Approval (#th preference) [many entries]"] = "Konsentoj (#-aj preferoj)";
["Approval (#th preference) [single entry]"] = "Konsento (#-a prefero)";
["Approval (first preference) [many entries]"] = "Konsentoj (unuaj preferoj)";
["Approval (first preference) [single entry]"] = "Konsento (unua prefero)";
["Approval (second preference) [many entries]"] = "Konsentoj (duaj preferoj)";
["Approval (second preference) [single entry]"] = "Konsento (dua prefero)";
["Approval (third preference) [many entries]"] = "Konsentoj (triaj preferoj)";
["Approval (third preference) [single entry]"] = "Konsento (tria prefero)";
["Approval [many entries]"] = "Konsento";
...
["Ballot of '#{member_name}' for issue ##{issue_id}"] = "Balotilo de '#{member_name}' por temo ##{issue_id}";
...
["Disapproval (prefer to last block) [many entries]"] = "Malkonsento (preferi al la lasta bloko)";
["Disapproval (prefer to last block) [single entry]"] = "Malkonsento (preferi al la lasta bloko)";
["Disapproval (prefer to lower block) [many entries]"] = "Malkonsento (preferi al la malsupra bloko)";
["Disapproval (prefer to lower block) [single entry]"] = "Malkonsento (preferi al la malsupra bloko)";
["Disapproval (prefer to lower blocks) [many entries]"] = "Malkonsento (preferi al la malsupraj blokoj)";
["Disapproval (prefer to lower blocks) [single entry]"] = "Malkonsento (preferi al la malsupraj blokoj)";
["Disapproval [many entries]"] = "Malkonsento";
["Disapproval [single entry]"] = "Malkonsento";
["Discard voting"] = "Retiri voĉdonado";
["Discussion"] = "Diskuto";
...
["EXPERIMENTAL FEATURE"] = "EKSPERIMENTA ECO";
["Edit"] = "Redakti";
...
["Information about the available policies"] = "Informo pri la disponeblaj politikoj";
["Initiated"] = "Lanĉita";
...
["Member has not approved latest draft"] = "La membro ne konsentis la plejn malfruen skizon";
...
["This identifier is not allowed for this instance."] = "Tiu identigilo ne estas permesata por ĉi tiu instanco.";
...
["This issue has been finished with the following winning initiative:"] = "Tiu temo estas finita kun la sekvanta sukzesa iniciato:";
["This issue has been finished without any winning initiative."] = "Tiu temo estas finita sen sukzesa iniciato.";
...
["This member is participating, the rest of delegation chain is suspended while discussing"] = "Tiu membro partoprenas, la resta delegacioĉeno estas blokata dum la diskuto";
...
["This report can be saved (use 'save complete website') and used offline."] = "Vi povas konservi tiun raporton (kun 'konservi tutan retpaĝon') kaj uzi senkonekte";
...
["disabled"] = "malaktiva"; -- aŭ malvalida
["email"] = "Retpoŝto";
