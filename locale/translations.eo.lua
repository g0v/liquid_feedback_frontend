...
["Abstention [many entries]"] = "Sindeteno [many entries]";
["Abstention [single entry]"] = "Sindeteno [single entry]";
...
["Any"] = "Kelkaj";
["Approval (#th preference) [many entries]"] = "Konsento (-a prefero) [many entries]";
["Approval (#th preference) [single entry]"] = "Konsento (-a prefero) [single entry]";
["Approval (first preference) [many entries]"] = "Konsento (unua prefero) [many entries]";
["Approval (first preference) [single entry]"] = "Konsento (unua prefero) [single entry]";
["Approval (second preference) [many entries]"] = "Konsento (dua prefero) [many entries]";
["Approval (second preference) [single entry]"] = "Konsento (dua prefero) [single entry]";
["Approval (third preference) [many entries]"] = "Konsento (tria prefero) [many entries]";
["Approval (third preference) [single entry]"] = "Konsento (tria prefero) [single entry]";
["Approval [many entries]"] = "Konsento [many entries]";
["Approval [single entry]"] = "Konsento [single entry]";
["Approved"] = "Konsentita";
...
["Disapproval (prefer to last block) [many entries]"] = "Malkonsento (preferi al la lasta bloko) [many entries]";
["Disapproval (prefer to last block) [single entry]"] = "Malkonsento (preferi al la lasta bloko) [single entry]";
["Disapproval (prefer to lower block) [many entries]"] = "Malkonsento (preferi al la malsupra bloko) [many entries]";
["Disapproval (prefer to lower block) [single entry]"] = "Malkonsento (preferi al la malsupra bloko) [single entry]";
["Disapproval (prefer to lower blocks) [many entries]"] = "Malkonsento (preferi al la malsupraj blokoj) [many entries]";
["Disapproval (prefer to lower blocks) [single entry]"] = "Malkonsento (preferi al la malsupraj blokoj) [single entry]";
["Disapproval [many entries]"] = "Malkonsento [many entries]";
["Disapproval [single entry]"] = "Malkonsento [single entry]";
