...
["Area delegated"] = "Temarodelegacio";
["Area delegated to '#{name}'"] = "Temarodelegacio '#{name}'";
...
["Issue delegated to '#{name}'"] = "Delegacio por temo '#{name}'";
...
["Show all areas of this unit"] = false;
