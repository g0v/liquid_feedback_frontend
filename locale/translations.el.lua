...
["#{count} in discussion"] = "#{count} σε συζήτηση";
...
["Not voted (not admitted)"] = "Δεν έχει ψηφιστεί (δεν προκρίθηκε)";
...
["One of them have an area delegation set"] = "Μία απ' αυτές έχει μία ανάθεση τομέα";
