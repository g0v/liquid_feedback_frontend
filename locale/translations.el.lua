...
["#{count} more areas in this unit, #{delegated_count} of them are delegated"] = "#{count} επιπλέον τομείς σε αυτή την ενότητα, #{delegated_count} εκ των οποίων έχουν ανατεθεί";
...
["Admin?"] = "Διαχειριστής;";
["Admission time"] = "Χρόνος παραδοχής";
["Admitted"] = "Παραδεκτή";
...
["Area delegated to '#{name}'"] = "Έχετε αναθέσει αυτόν τον τομέα στον/στην '#{name}";
["Area delegation"] = "Ανάθεση τομέα";
["Area list of '#{unit_name}'"] = "Τομείς ενότητας '#{unit_name}'";
["Area successfully updated"] = "Ο τομέας ενημερώθηκε επιτυχώς";
["Areas"] = "Τομείς";
["Author"] = "Συντάκτης";
["Avatar"] = "Εικόνα";
["Back"] = "Πίσω";
["Back to timeline"] = "Πίσω στο χρονολόγιο";
["Back to unit list"] = "Πίσω στις ενότητες";
...
["Cancelled (no initiative admitted)"] = "Ακυρώθηκε (Δεν εγκρίθηκε καμία πρωτοβουλία)";
["Change area delegation"] = "Αλλαγή ανάθεσης για τον τομέα";
["Change display settings"] = "Αλλαγή ρυθμίσεων παρουσίασης";
["Change email"] = "Αλλαγή email";
["Change email address"] = "Αλλαγή διεύθυνσης email";
["Change global delegation"] = "Αλλαγή καθολικής ανάθεσης";
...
["Change your name"] = "Αλλαγή ονόματος";
...
["Click for details"] = "Κλικ για λεπτομέρειες";
["Closed"] = "Κλειστό";
...
["Delegation problems"] = "Προβλήματα ανάθεσης";
...
["Discussion time"] = "Χρόνος για συζήτηση";
["Discussion with initiators"] = "Συζήτηση με τους εισηγητές";
["Display settings"] = "Ρυθμίσεις παρουσίασης";
["Download"] = "Κατέβασμα";
...
["Email unconfirmed"] = "Ανεπιβεβαίωτη διεύθυνση email";
...
["Error while resolving openid. Internal message: '#{errmsg}'"] = "Σφάλμα κατά την επίλυση OpenID. Εσωτερικό μήνυμα: '#{errmsg}'";
...
["Events"] = "Συμβάντα";
["External memberships"] = "Εξωτερικές συνδρομές";
["External posts"] = "Εξωτερικές δημοσιέυσεις";
...
["Global delegation set to '#{name}'"] = "Έχει οριστεί καθολική ανάθεση στον/στην '#{name}'";
["Global search"] = "Καθολική αναζήτηση";
["Global timeline"] = "Καθολικό χρονολόγιο";
...
["I like to receive notifications about events in my areas and issues:"] = "Θέλω να λαμβάνω ειδοποιήσεις σχετικά με τα γεγονότα στους τομείς και τα θέματά μου:";
["Id"] = "Id";
["Ident number"] = "Αριθμός ταυτοποίησης";
...
["Initiative details"] = "Λεπτομέρειες πρωτοβουλίας";
...
["Initiatives in this area (last created first)"] = "Πρωτοβουλίες σ' αυτόν τον τομέα (η τελευταία δημιουργήθηκε πρώτη)";
["Initiatives in this area (last updated first)"] = "Πρωτοβουλίες σ' αυτόν τον τομέα (η τελευταία ενημερώθηκε πρώτη)";
["Initiatives in this issue (last created first)"] = "Πρωτοβουλίες σ' αυτό το θέμα (η τελευταία δημιουργήθηκε πρώτη)";
["Initiatives in this issue (last updated first)"] = "Πρωτοβουλίες σ' αυτό το θέμα (η τελευταία ενημερώθηκε πρώτη)";
...
["Issue delegated to '#{name}'"] = "Το θέμα ανατέθηκε στον/στην '#{name}'";
["Issue delegation"] = "Ανάθεση θέματος";
["Issue details"] = "Λεπτομέρειες θέματος";
...
["Member is administrator"] = "Αυτό το μέλος είναι διαχειριστής";
["Member is already saved in your contacts!"] = "Αυτό το μέλος είναι ήδη αποθηκευμένο στις επαφές σας!";
["Member is deactivated"] = "Το μέλος έχει απενεργοποιηθεί";
...
["Member voting"] = "Ψηφοφορία";
["Member: '#{login}' (#{name})"] = "Μέλος: '#{login}' (#{name})";
["Members"] = "Μέλη";
...
["Message of the day"] = "Το μήνυμα της ημέρας";
...
["Not voted (not admitted)"] = "Δεν έχει ψηφιστεί (μη εισηγμένο)";
["Not voted (revoked from initiator)"] = "Δεν έχει ψηφιστεί (αποσύρθηκε από εισηγητή)";
...
["Number of initiatives to preview"] = "Πλήθος πρωτοβουλιών στην προεπισκόπιση";
["OK"] = "ΟΚ";
...
["Personal timeline"] = "Προσωπικό χρονολόγιο";
["Phases"] = "Στάδια";
["Phone"] = "Τηλέφωνο";
["Photo"] = "Φωτογραφία";
...
["Policy successfully updated"] = "Ο κανονισμός ενημερώθηκε επιτυχώς";
["Population"] = "Πληθυσμός";
["Posts"] = "Δημοσιέυσεις";
["Potential supported"] = "Ενδεχομένως υποστηρίζεται";
["Potential supporter"] = "Δυνητικοί υποστηρικτές";
...
["Recently closed"] = "Ολοκληρώθηκε προσφάτως";
...
["Search for initiatives"] = "Αναζήτηση για πρωτοβουλίες";
...
["Search term (only complete words)"] = "Όροι αναζήτησης (μόνο πλήρης λέξεις)";
["Select language \"#{langcode}\""] = "Επιλογή γλώσσας \"#{langcode}\"";
["Send invite?"] = "Αποστολή πρόσκλησης;";
["Set URL"] = "Ορισμός URL";
["Set area delegation"] = "Ανάθεση του τομέα";
["Set delegation for Area '#{name}'"] = "Ανάθεση του τομέα '#{name}'";
["Set delegation for Issue ##{number} in Area '#{area_name}'"] = "Ανάθεση του θέματος ##{number} στον τομέα '#{area_name}'";
["Set global delegation"] = "Καθολική ανάθεση";
["Set issue delegation"] = "Ανάθεση θέματος";
["Set new password"] = "Ορισμός νέου κωδικού";
["Set unit delegation"] = "Ανάθεση ενότητας";
["Settings"] = "Επιλογές";
["Show"] = "Προβολή";
["Show active members"] = "Προβολή ενεργών μελών";
...
["Show locked members"] = "Προβολή μπλοκαρισμένων μελών";
...
["Sorry, it was not possible to verify your OpenID."] = "Λυπούμαστε, δεν ήταν δυνατή η επιβεβαίωση του OpenID σας.";
...
["Step 1/3: Invite code"] = "Βήμα 1/3: Κωδικός πρόσκλησης";
["Step 2/3: Personal information"] = "Βήμα 2/3: Προσωπικά στοιχεία";
["Step 3/3: Terms of use and password"] = "Βήμα 3/3: Όροι χρήσης και κωδικός πρόσβασης";
...
["Supporter"] = "Υποστηρικτές";
["Supporter count"] = "Πλήθος υποστηρικτών";
...
["This identifier is not allowed for this instance."] = "Αυτό το αναγνωριστικό δεν επιτρέπεται σε αυτή την περίπτωση.";
["This initiative"] = "Αυτή η πρωτοβουλία";
["This initiative compared to alternative initiatives"] = "Αυτή η πρωτοβουλία συγκρινόμενη με εναλλακτικές πρωτοβουλίες";
["This initiative has been revoked at #{revoked}"] = "Αυτή η πρωτοβουλία έχει ανακληθεί στις #{revoked}";
["This initiative has not been admitted! It failed the quorum of #{quorum}."] = "Αυτή η πρωτοβουλία δεν έγινε παραδεκτή. Δεν είχε την απαιτούμενη απαρτία #{quorum}.";
...
["This member has voting privileges for this unit, but you ist not member of any of its areas."] = "Αυτό το μέλος έχει δικαίωμα ψήφου σε αυτήν την ενότητα αλλά δεν είναι μέλος κάποιου τομέα της.";
...
["This member is deactivated."] = "Αυτό το μέλος έχει απενεργοποιηθεί.";
...
["This username is too short!"] = "Αυτό το όνομα χρήστη είναι πολύ μικρό!";
["Thursday"] = "Πέμπτη";
...
["Unit"] = "Ενότητα";
["Unit delegated to '#{name}'"] = "Η ενότητα έχει ανατεθεί στον/στην '#{name}'";
...
["Withdraw interest"] = "Απόσυρση ενδιαφέροντος";
["Withdraw membership"] = "Απόσυρση συμμετοχής";
["Withdraw support"] = "Απόσυρση υποστήριξης";
["Yes"] = "Ναι";
["Yesterday"] = "Χτες";
...
["You are potentially supporter of this initiative"] = "Είστε δυνητικός υποστηρικτής αυτής της πρωτοβουλίας";
...
["You have saved this member as contact"] = "Έχετε αποθηκεύσει αυτό το μέλος ως επαφή";
["You have saved this member as contact."] = "Έχετε αποθηκεύσει αυτό το μέλος ως επαφή.";
["You have to mark 'Are you sure' to revoke!"] = "Πρέπει να μαρκάρετε το 'Είστε σίγουροι;' για να ανακαλέσετε";
["You have voting privileges for this unit, but you are not member of any of its areas."] = "Έχετε δικαίωμα ψήφου σε αυτήν την ενότητα αλλά δεν είστε μέλος κάποιου τομέα της.";
...
["Your are interested"] = "Σας ενδιαφέρει";
["Your are potential supporter"] = "Είστε πιθανός υποστηρικτής";
["Your are supporter"] = "Είστε υποστηρικτής";
["Your delegation for this area has been deleted."] = "Η ανάθεση σας για τον τομέα διαγράφηκε";
["Your delegation for this area has been updated."] = "Η ανάθεση σας για τον τομέα ενημερώθηκε";
["Your delegation for this issue has been deleted."] = "Η ανάθεση σας για το θέμα διαγράφηκε";
["Your delegation for this issue has been updated."] = "Η ανάθεση σας για το θέμα ενημερώθηκε";
["Your delegation for this unit has been deleted."] = "Η ανάθεση σας για την ενότητα διαγράφηκε";
["Your delegation for this unit has been updated."] = "Η ανάθεση σας για την ενότητα ενημερώθηκε";
["Your display settings have been updated"] = "Οι ρυθμίσεις παρουσίασης ενημερώθηκαν";
...
["must"] = "συμφωνώ απολύτως";
["must not"] = "διαφωνώ απολύτως";
["neutral"] = "ουδέτερη";
