...
local function supporters()
  ...
  members_selector = Member:new_selector()
    ...
    :join("direct_supporter_snapshot", nil, "direct_supporter_snapshot.event = issue.latest_snapshot_event AND direct_supporter_snapshot.issue_id = issue.id AND direct_supporter_snapshot.member_id = member.id")
...
local function nonsupporters()
  ...
  members_selector = Member:new_selector()
    :join("rating", nil, "member.id = rating.member_id")
    :join("issue", nil, "issue.id = rating.issue_id")
    :left_join("direct_supporter_snapshot", nil, "direct_supporter_snapshot.event = issue.latest_snapshot_event AND direct_supporter_snapshot.issue_id = issue.id AND direct_supporter_snapshot.member_id = member.id")
